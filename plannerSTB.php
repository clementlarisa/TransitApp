    ...
    <div class="container bg-light" style="height:100%;">
        <div class="row">
            <div class="col-md-6" style="background-color:lavender;top:20px">
                ...
                <img class="img-rounded img-responsive" src="Imagini/ab-stb.jpg" class="img-rounded img-responsive"
                     alt="Abonament STB" style="width:70%; margin: auto; display:block">
                <div>
                    <p>
                        <a href="stb-buy.php" class="btn btn-lg btn-primary" style="margin: auto; display:table">Cumpara
                            abonament/calatorii</a>
                    </p>
                </div>
            </div>
            <div class="col-md-6 col-md-offset-4" style="background-color:lavender; left:5%;top:20px">
                <div class="hovereffect">
                    ...
                    <img class="img-rounded img-responsive" src="Imagini/stb-route.png"
                         class="img-rounded img-responsive" alt="Route" style="width:44%; margin: auto; display:block">
                    <div class="overlay">
                        <p>
                            <a href="routePlanner.php" class="btn btn-lg btn-primary"
                               style="margin: auto; display:table">Planificator calatorii</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-8" style="background-color:lavender;left:30%;top:30px">
                <img class="img-rounded img-responsive" src="Imagini/stb-history.png" class="img-rounded img-responsive"
                     alt="History " style="width:44%; margin: auto; display:block">
                <div>
                    <p>
                        <a href="#" class="btn btn-lg btn-primary" style="margin: auto; display:table">Istoric
                            calatorii</a>
                    </p>
                </div>
