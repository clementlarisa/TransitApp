                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab  item" style="left:10%">
                    <div class="folded-corner service_tab_1">
                        <div class="text">
                            ...
                            <p>
                                Fiecare abonament dispune de un id unic si expira la 30 de zile de la activarea
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item" style="left:27%">
            <div class="folded-corner service_tab_1">
                <div class="text">
                    ...
                    <p>
                        Fiecare calatorie dispune de un cod unic pe care va trebui sa il prezentati la orice control din
                        mijlocul de transport in comun, la cererea personaelor autorizate. O calatorie costa 1,30 lei.
                    </p>
